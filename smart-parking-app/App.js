    ...
    return (
        <NavigationContainer>
            <Stack.Navigator initialRouteName="Login">
                ...
                <Stack.Screen name="AddParkingLot" component={AddParkingLot} options={{ title: 'Add Parking Lot' }} />
                <Stack.Screen name="ManageParking" component={ManageParking} options={{ title: 'Manage Parking' }} />
                <Stack.Screen name="SendNotification" component={SendNotification} options={{ title: 'Send Notification' }} />
            </Stack.Navigator>
        </NavigationContainer>
    );
}
